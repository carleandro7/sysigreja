class EstudobiblicosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estudobiblico.save
        format.html { redirect_to @estudobiblico, notice: "Estudobiblico was successfully created." }
  ...
  def update
    respond_to do |format|
      if @estudobiblico.update(estudobiblico_params)
        format.html { redirect_to @estudobiblico, notice: "Estudobiblico was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to estudobiblicos_path, status: :see_other, notice: "Estudobiblico was successfully destroyed." }
